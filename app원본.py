...
def show_email_modal():
    ...
    st.markdown("""
        <style>
        /* 1. background for pop-up: very very light gray (#F7F7F7) */
        ...
        /* 2. enter email: white background + wine color letter */
        ...
        /* text in the box should be white! */
        section[data-testid="stDialog"] div[data-testid="stButton"] > button * {
            color: #FFFFFF !important;
        ...
        /* 4. close(X) button dark redish purple  */
